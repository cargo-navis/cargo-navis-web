...
export function Sidebar() {
  ...
  return (
    <Box className="flex flex-col gap-[40px] flex-grow">
      ...
      <Box className="group cursor-pointer h-[48px] flex rounded-s p-3 text-sm font-medium hover:bg-light-50 hover:text-teal-900 md:flex-none md:p-2 md:px-3" onClick={handleSignOut}>
