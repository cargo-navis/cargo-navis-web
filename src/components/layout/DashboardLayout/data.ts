...
export const links: NavLink[] = [
  ...
  // { name: 'Loading Planer', href: '/loading-planer', icon: HomeIcon }, // TODO
  {
    ...
    icon: 'TruckIcon',
    subItems: [
      { name: 'Truck', href: '/dashboard/fleet/trucks', icon: 'ChevronRightIcon' },
      { name: 'Trailer', href: '/dashboard/fleet/trailer', icon: 'ChevronRightIcon' },
      { name: 'Solo', href: '/dashboard/fleet/solo', icon: 'ChevronRightIcon' },
      { name: 'Van', href: '/dashboard/fleet/van', icon: 'ChevronRightIcon' },
    ],
  },
