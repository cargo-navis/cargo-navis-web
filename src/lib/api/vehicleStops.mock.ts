...
const addresses = [
  { id: 'addr-01', streetName: 'Ilica 1', postalCode: '10000', countryCode: 'HR', placeName: 'Zagreb' },
  { id: 'addr-02', streetName: 'Vukovarska 58', postalCode: '10000', countryCode: 'HR', placeName: 'Zagreb' },
  { id: 'addr-03', streetName: 'Slavonska avenija 6', postalCode: '10000', countryCode: 'HR', placeName: 'Zagreb' },
  { id: 'addr-04', streetName: 'Radnička cesta 37b', postalCode: '10000', countryCode: 'HR', placeName: 'Zagreb' },
  { id: 'addr-05', streetName: 'Heinzelova 62', postalCode: '10000', countryCode: 'HR', placeName: 'Zagreb' },
  { id: 'addr-06', streetName: 'Korzo 1', postalCode: '51000', countryCode: 'HR', placeName: 'Rijeka' },
  { id: 'addr-07', streetName: 'Fiumara 13', postalCode: '51000', countryCode: 'HR', placeName: 'Rijeka' },
  { id: 'addr-08', streetName: 'Riva 16', postalCode: '21000', countryCode: 'HR', placeName: 'Split' },
  { id: 'addr-09', streetName: 'Vukovarska 1', postalCode: '21000', countryCode: 'HR', placeName: 'Split' },
  { id: 'addr-10', streetName: 'Kneza Trpimira 2', postalCode: '21000', countryCode: 'HR', placeName: 'Split' },
  { id: 'addr-11', streetName: 'Stradun 1', postalCode: '20000', countryCode: 'HR', placeName: 'Dubrovnik' },
  { id: 'addr-12', streetName: 'Boškovićeva 5', postalCode: '20000', countryCode: 'HR', placeName: 'Dubrovnik' },
  { id: 'addr-13', streetName: 'Europska avenija 4', postalCode: '31000', countryCode: 'HR', placeName: 'Osijek' },
  { id: 'addr-14', streetName: 'Kapucinska 40', postalCode: '31000', countryCode: 'HR', placeName: 'Osijek' },
  { id: 'addr-15', streetName: 'Županijska 6', postalCode: '31000', countryCode: 'HR', placeName: 'Osijek' },
  { id: 'addr-16', streetName: 'Trg Ante Starčevića 8', postalCode: '43000', countryCode: 'HR', placeName: 'Bjelovar' },
  { id: 'addr-17', streetName: 'Masarykova 14', postalCode: '43000', countryCode: 'HR', placeName: 'Bjelovar' },
  { id: 'addr-18', streetName: 'Frankopanska 1', postalCode: '47000', countryCode: 'HR', placeName: 'Karlovac' },
  { id: 'addr-19', streetName: 'Prilaz Vladislava Brajkovića 2', postalCode: '47000', countryCode: 'HR', placeName: 'Karlovac' },
  { id: 'addr-20', streetName: 'Obala kneza Branimira 9', postalCode: '23000', countryCode: 'HR', placeName: 'Zadar' },
  { id: 'addr-21', streetName: 'Široka ulica 3', postalCode: '23000', countryCode: 'HR', placeName: 'Zadar' },
  { id: 'addr-22', streetName: 'Trg Slobode 12', postalCode: '42000', countryCode: 'HR', placeName: 'Varaždin' },
  { id: 'addr-23', streetName: 'Optujska 2', postalCode: '42000', countryCode: 'HR', placeName: 'Varaždin' },
  { id: 'addr-24', streetName: 'Pavelinska 3', postalCode: '48000', countryCode: 'HR', placeName: 'Koprivnica' },
  { id: 'addr-25', streetName: 'Trg bana Jelačića 7', postalCode: '48000', countryCode: 'HR', placeName: 'Koprivnica' },
];
